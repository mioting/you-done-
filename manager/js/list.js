...
function deleteProjectForm() {
  document
    .querySelector("#deletepjt")
    .addEventListener("submit", async (e) => {
      e.preventDefault();
      const form = e.target;
      const formBody = {
        id: selectedProject,
        is_completed: form.completebox.checked
      };
      const resp = await fetch("/project", {
        method: "delete",
        headers: {
...
document.querySelector("#newsubTasksss").addEventListener("click", loadSubtasksUser, { once: true })
